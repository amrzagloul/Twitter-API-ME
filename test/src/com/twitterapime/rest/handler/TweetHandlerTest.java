...
public class TweetHandlerTest extends TestCase {
	...
	/**
	 * Test method for {@link com.twitterapime.rest.handler.TweetHandler#getParsedTweet()}.
	 */
	public void testGetParsedTweet() {
		...
		assertEquals(0, new TweetHandler().getParsedTweet().size());
	}

	/**
	 * Test method for {@link com.twitterapime.rest.handler.TweetHandler#loadParsedTweet(com.twitterapime.search.Tweet)}.
	 */
